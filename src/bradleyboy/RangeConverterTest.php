...
class RangeConverterTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('1..5', $this->converter->reduceRanges(
            array(1, 2, 3, 4, 5)
        ));
    }
    ...
    {
        $this->assertEquals('1..3,5', $this->converter->reduceRanges(
            array(1, 2, 3, 5)
        ));
    }
    ...
    {
        $this->assertEquals('1..3,5,8..11', $this->converter->reduceRanges(
    ...
    {
        $this->assertEquals('1,2,5', $this->converter->reduceRanges(
            array(1, 2, 5)
        ));
    }
    ...
    {
        $this->assertEquals('1,2,5,6,9..11', $this->converter->reduceRanges(
    ...
    {
        $this->assertEquals('1,5..7,10', $this->converter->reduceRanges(
            array(1, 5, 6, 7, 10)
        ));
    }
    ...
    {
        $this->assertEquals(array(1, 5, 6, 7, 10), $this->converter->expandRanges('1,5..7,10'));
    }
}
